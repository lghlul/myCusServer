	...
	var handleDateTimePickers = function () {
        ...
        $('#reportrange').daterangepicker(
           ...
           /*  ranges: {
            ...
            function(start, end) {
             console.log("含有不合法的输入！");
             $('#reportrange span').html(start.format('YYYY-MM-DD') + ' - ' + end.format('YYYY-MM-DD'));//按钮上显示方式
            }
         );
         //Set the initial state of the picker label
         $('#reportrange span').html('日期选择');
    }
...
*/
	...
	/*-----------------------------------------------------------------------------------*/
	/*	Handles flot charts in dashboard xly图表
	/*-----------------------------------------------------------------------------------*/
	...
	/*-----------------------------------------------------------------------------------*/
	/*	Handles Profile Edit处理配置文件编辑xly
	/*-----------------------------------------------------------------------------------*/
