	...
	$.fn.extend({
				takungaeImgup : function(opt, serverCallBack) {
					...
					var defaults = {
						...
						fileSize : (1024 *  1024 * 1)/2, // 上传文件的大小 500k
						count : 0
					// 计数器
					};
				...
				/*		if (fileList.length > imageNum|| totalNum > imageNum) {
							...
							for ( var i = 0; i < fileList.length; i++) {
								...
								var $img = $("<img style='width:217px;height:125px'>");
								//alert(1)
								//alert($('#mainfigure').val()+"哈哈哈哈");
								$img.attr("src",$('#mainfigure').val());
