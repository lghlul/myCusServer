;(function($) {
	...
	$.fn.extend({
				takungaeImgup2 : function(opt, serverCallBack) {
					...
					var defaults = {
						...
						fileSize : (1024 *  1024 * 1)/2, //500k   上传文件的大小 10M 1024 * 1024 * 10
						count : 0
					// 计数器
					};
					...
					$(this).change(function() {
						...
						if (fileList.length > imageNum|| totalNum > imageNum) {
							alert("上传图片数目不可以超过2个，请重新选择"); // 一次选择上传超过5个
							...
							for ( var i = 0; i < fileList.length; i++) {
								...
								var $img = $("<img id="+index+" class='coachimg' style='width:217px;height:125px'>");
