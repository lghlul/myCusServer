$(function() {
    ...
    function animate() {
        $ani.each(function(index, item) {
            ...
            if (h > $(item).offset().top + 20) {
                $(item).trigger("diyShow");
                if (index === $ani.length - 1) {
...
$(function() {
    var domEle = {
        ...
        windowMain: $(window),
        bodyEle: $("body"),
        stopAnimte: $(".slide,.prev,.next,.item_banner"),
        prev: $(".prev"),
        next: $(".next"),
        slide: $(".slide"),
        slideCur: $(".item_banner a"),
        phoneImg: $(".phone-img"),
        codeImg: $(".code-img")
    };
...
$(function(){
        ...
        $("#menu ul li").click(function(){
            ...
            //scrollTop滚动到对应高度
            $("body,html").animate({scrollTop:_top},360);
        });
        var nav=$("#menu"); //得到导航对象
        ...
        win.scroll(function(){
            ...
            if(sc.scrollTop()>=600){
                $("#menu").show();
                //获取滚动元素对应的索引!!!重难点
                var index=Math.floor(sc.scrollTop()/450);
...
(function() {
    ...
    hm.src = "https://hm.baidu.com/hm.js?d3ea20779de0f936c95c629c72e09837";
