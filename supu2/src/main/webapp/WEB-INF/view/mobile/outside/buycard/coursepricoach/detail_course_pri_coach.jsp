	...
	<script>
			$(function() {
                ...
                function getCommentList(){
                    $.ajax({
                        type:"GET",
                        url:baseUrl+"/outside/comment/getCommenListPublic?source=4&sourceID="+sourceID+"&limitstart=0&limitend=10",
...
//评价来源标识：1私教课2团课3门店4私教
                $(".comment").on("click",function(){
                    //弹出框
                    window.location.href= "/outside/comment/priCourseComment?id="+id+"&source=4";
                })
