        ...
        <!--         <div data-v-6030a3e6="" class="swiper-slide swiper-slide-next" style="width: 375px;">
            ...
            <div data-v-a8d8e73a="" class="main">
                ...
                <div data-v-56e2b5a2="" data-v-a8d8e73a="" class="box-list">
                    <a data-v-56e2b5a2="" href="#/mapview?lat=32.071392&amp;lng=118.773575&amp;address=%E9%A9%AC%E5%8F%B0%E8%A1%9799%E5%8F%B7%E5%9F%8E%E5%B8%82%E9%9B%86%E5%B8%82%E4%B8%89%E6%A5%BC301&amp;name=%E9%A9%AC%E5%8F%B0%E8%A1%97%E5%BA%97" class="">
                        <div data-v-56e2b5a2="" class="place-box">
                            <div data-v-56e2b5a2="" class="box-info">
                                <p data-v-56e2b5a2=""><fmt:formatDate value="${date}" pattern="yyyy.MM.dd" />
                             <%--    ${courseExcGroup.starthour }:${courseExcGroup.startmin }-${courseExcGroup.endhour }:${courseExcGroup.endmin } --%>
                             ${startTime}-${endTime}
                                </p>
                    ...
                    <form id="form">
                    	<input type="hidden" id="appointtime" name="appointtime" value="<fmt:formatDate value="${date}" pattern="yyyy-MM-dd" />"></input>
						<input type="hidden" id="starttime" name="starttime" value="${startTime}"></input>
						<input type="hidden" id="endtime" name="endtime" value="${endTime}"></input>
						<input type="hidden" id="courseid" name="courseid" value="${courseExcGroup.id }"></input>
						<input type="hidden" id="storeid" name="storeid" value="${store.storeId }"></input>
                    </form>

					<!-- 提交表单  刷新团课预约页面 -->
                    <form id="courseGroupform" action="<%=request.getContextPath()%>/outside/aboutClass/courseGroupDetail" method="post">
                    	<input type="hidden" id="" name="date" value="<fmt:formatDate value="${date}" pattern="yyyy-MM-dd" />"></input>
						<input type="hidden" id="" name="id" value="${courseExcGroup.id }"></input>
						<input type="hidden" id="" name="storeId" value="${store.storeId }"></input>
						<input type="hidden"  name="startTime" value="${startTime}"></input>
						<input type="hidden"  name="endTime" value="${endTime}"></input>
                    </form>
<%--                     <input type="hidden" id="id" name="storeid" value="${id }"></input> --%>
                </div>
...
<!-- 提交成功弹出层 -->
<div  class="mask success_form_submit" style="display:none;"></div>
<div id="alertquenen_success_form_submit" class="mint-msgbox-wrapper" style="position: absolute; z-index: 2013; display:none;">
    <div class="mint-msgbox" style="display:block;">
        <div class="mint-msgbox-header">
            <div class="mint-msgbox-title" id="successMassage_form_submit"></div>
        </div>
        <div class="mint-msgbox-content">
            <div class="mint-msgbox-message"></div>
            <div class="mint-msgbox-input" style="display: none;">
        ...
        <div class="mint-msgbox-btns">
        	<button class="mint-msgbox-btn mint-msgbox-cancel success_sure_cancel">确定</button>
            <button class="mint-msgbox-btn mint-msgbox-cancel success_sure_cancel" style="">取消</button>
        </div>
    </div>
</div>
...
<script>
    ...
    $(function(){
        ...
        $(".comment").on("click",function(){
            //弹出框
            window.location.href= "/outside/comment/priCourseComment?id="+sourceID+"&source=2";
        })
