		...
		<div id="app" style="height: 100%; overflow: initial;">
			<div class="wrap isTabBar">
				...
				<div class="le-container">
					...
					<%--href="<%=request.getContextPath()%>/outside/loginout"--%>
					<a  id="logout" class="mint-button logOut mint-button--default mint-button--large">
						<label class="mint-button-text">清空缓存</label></a>
				</div>
		...
		<script>
			$(function(){
                ...
                $("#logout").on("click",function(){
                    ...
                    $.cookie('openid',   null, { path:"/",expires: -1 });
                    $.cookie('nickName', null, { path:"/",expires: -1 });
                    $.cookie('headimgurl', null, { path:"/",expires: -1 });
