						...
						<button type="button" type="button" class="mint-button le-city-btn mint-button--default mint-button--normal"><!---->
							<label class="mint-button-text">
								<div class="city-selector">
									<img src="/assets/images/newui/gps.png" style="width: 11px;">&nbsp;
					...
					<div  class="head-fixed-select">
						<div  class="">
							<div  class="select-btn yk_select">
								<img src="/assets/images/newui/indextype.png" style="width: 15px;">&nbsp;
                                <span >基础团课</span>
                                <span >
                                    <i  class="icon iconfont icon-xiangshangsanjiaoshouqi"></i>
                                </span>
                        ...
                        <div class="card-container">
                            ...
                            <div class="mint-tab-container-item card-list card-class">
                                ...
                                <a class="mint-cell card-item" href="<%=request.getContextPath()%>/outside/aboutClass/privatePage">
                               	...
                               	<a class="mint-cell card-item" href="<%=request.getContextPath()%>/outside/aboutClass/studioPage">
                                    <div class="mint-cell-left"></div>
                                    <div class="mint-cell-wrapper">
                                        <div class="mint-cell-title">
                                            <span class="mint-cell-text">工作室</span>
                                        </div>
                                        <div class="mint-cell-value">
                                            <span></span>
                                        </div>
                                ...
                                <a class="mint-cell card-item" href="<%=request.getContextPath()%>/outside/aboutClass/courseGroupPage">
                                    <div class="mint-cell-left"></div>
                                    <div class="mint-cell-wrapper">
                                        <div class="mint-cell-title">
                                            <span class="mint-cell-text">训练营</span>
                                        </div>
                                        <div class="mint-cell-value">
                                            <span></span>
                                        </div>
								...
								<div class="mint-navbar dark weui_navbar">
									<c:forEach items="${weekAndDate }" var="items" varStatus="status">
 										<c:choose>
											...
											<c:otherwise>
												<a class="mint-tab-item " data-data="周${items.week }" data-id="${status.index }" data-date="${items.date }" data-week="${items.numWeek }">
													<div class="mint-tab-item-icon"></div>
													<div class="mint-tab-item-label">
							...
							<div class="swiper-container le-class-swipe swiper-container-horizontal swiper-container-autoheight ">
								<div class="swiper-wrapper">
									<div class="le-class-items swiper-slide" style=" display:block;">
										<div>
											<div  id="today" style="padding: 8px;">
...
<!-- 											<div class="empty-box" style="display: none;">
									...
									<div class="le-class-items swiper-slide" >
										<div>
											<div  id="todaynextone" style="padding: 8px;">
									...
									<div class="le-class-items swiper-slide" >
									    <div>
									    	<div  id="todaynexttwo" style="padding: 8px;">

											</div>
										</div>
                                    </div>
									<div class="le-class-items swiper-slide ">
									    	<div  id="todaynextthree" style="padding: 8px;">

											</div>
                                    </div>
									<div class="le-class-items swiper-slide">
									    	<div  id="todaynextfour" style="padding: 8px;">

											</div>
                                    </div>
									<div class="le-class-items swiper-slide">
									    	<div  id="todaynextfive" style="padding: 8px;">

											</div>
                                    </div>
									<div class="le-class-items swiper-slide">
									    	<div  id="todaynextsix" style="padding: 8px;">
