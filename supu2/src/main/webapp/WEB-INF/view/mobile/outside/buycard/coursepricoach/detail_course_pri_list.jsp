		...
		<div id="app">
			<div class="wrap">
				...
				<div class="le-container">
					...
					<div class="header-img" style="background-image: url('${coursePriCocah.courseimg }');"></div>
					<header class="header">
						<h3 class="title">${coursePriCocah.coursename }</h3>
...
<div id="commentDiv" class="">
	...
	评星:<input type="text" id="startlevel" value="">
	<input type="hidden" id="sourceID" value="${coursePriCocah.id }"><!-- 私教课的ID -->
	<br/>
	评价:<input type="text" id="contentText" value=""><!-- content -->
	<br/>
	<button type="button"  id="sendcomment">提交评价</button>
</div>  

<div>
<p>评星</p><div id="number" ></div><p>评价人数</p><div id="count" ></div>
</div>
<div class="tab-pane">
...
<%-- <script
	src="<%=request.getContextPath()%>/assets/js/user/userlist.js">
</script> --%>
