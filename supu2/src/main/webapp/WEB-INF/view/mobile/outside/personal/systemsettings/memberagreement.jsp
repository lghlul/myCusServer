		...
		<div class="leui-content leui-container-top weui-row weui-no-gutter">
			...
			<div class="leui-right-content weui-col-66">
				...
				<article class="weui-article" id="article-pt" style="display: none;">
					<section>
						<h2 class="title">私教课程协议</h2>
						<section>
							<h3>一、私教课程</h3>
							<p>1、速扑运动采用会员制服务模式，只有购买私教课程方能享受私人教练的各项专业健身服务及速扑相关配套服务。</p>
							<p>2、私教课程不予转让和退换。</p>
						...
						<section>
							<h3>三、教练职责</h3>
							<p>1、为私教会员制定一份健康档案，定期为私教会员做健康测试。</p>
							<p>2、在约定训练时间内为私教会员提供专业的健身服务。</p>
							<p>3、每次训练前给私教会员做出详细的健身计划。 </p>
						...
						<section>
							<h3>五、训练时间变更</h3>
							<p>1、如果私教会员希望变更原定训练时间，须在24小时前提出此要求。</p>
							<p>2、如果私教会员未能在24小时前提出取消原定课程，或者错过了一次原定的训练那么，私教会员将要支付该次原定训练的费用。</p>
							<p>3、训练时间一旦确定，健身教练会按时等候私教会员。如果会员迟到，迟到的时间将不获补偿，训练时间不会延长，将于原定时间结束。</p>
							<p>4、如果需要临时变更训练时间，由会员与健身教练具体协商。</p>
						</section>
						<section>
							<h3>六、教练变更</h3>
							<p>1、健身教练生病情况下，私教会员会在原定训练时间提前24小时得到通知。如果健身教练突然生病，无法在原定训练时间提前24小时通知私教会员的情况下，健身中心将为私教会员提供另一个教练或对私教会员的训练时间作出调整，由私教会员二者选其一。</p>
							<p>2、如果健身教练休假或离职，健身中心将为私教会员推荐多名健身教练供会员选择，完成剩余次数。</p>
							<p>3、私教会员不能随意更换健身教练，如需更换健身教练必须向本中心书面提出申请说明原因，如确需更换健身教练，须经此协议三方和新健身教练协商后签署更换健身教练同意书。</p>
							<!-- <p>4、如果需要临时变更训练时间，由会员与健身教练具体协商。</p> -->
						</section>
						<!-- <section>
							<h3>九、会员承诺</h3>
				...
				<article class="weui-article" id="article-camp" style="display: none;">
					<section>
						...
						<section>
							<h3>学员需知：</h3>
							<p>学员在参加训练时要按照健身教练的计划进行训练，如果未按照健身教练的指导进行练习所受的伤害以及负面的效果，学员自行承担责任；学员不得有隐瞒，否则发生任何相关安全问题，本公司及健身教练概不负责任。</p>
						</section>
						<section>
							...
							<p>健身学员确认健身教练一概不提供任何医疗咨询（只提供健身技巧方面的咨询帮助）。</p>
				...
				<article class="weui-article" id="article-yoga" style="display: none;">
					<section>
						<h2 class="title">SP瑜伽主题馆课程购买协议</h2>
						<section>
							<h3>一、会员卡</h3>
							<p>1、速扑运动SP瑜伽主题馆所有课程均采用会员制服务模式，只有购买相关课程课时的会员才能享受场馆的各项专业课程及相关配套服务。</p>
							<p>2、通过购买会员卡取得会员资格，应办理入会手续，并已知晓主题馆有关健身的规则与警示，承诺遵守训练馆的相关规定。</p>
						...
						<section>
							...
							<p>1、原始取得，指的是在微信公众账号“Spartner速扑运动”注册、填写真实、有效、全面的个人资料，办理入会手续和选择会员卡种类并缴纳会费后取得会员资格。</p>
							<p>2、主题馆课程次卡不予转让和退换。</p>
						</section>
						<!-- <section>
							<h3>三、电子会员次卡的管理</h3>
							<p>1、会员卡仅供会员本人使用（体验卡除外），一经售出，概不退换。</p>
						...
						<section>
							...
							<p>2、女会员在怀孕期间凭县级以上医院证明，可给予办理资格延期手续。</p>
							<p>3、会员在付款当月可以申请开具全额订单发票，过期不予开具。</p>
					...
					<!-- 	<section>
						...
						<section>
							<h3>六、课程训练时间变更</h3>
							<p>1、如果会员希望变更原预约课程时间，须在24小时前提出此要求。</p>
							<p>2、如果会员未能在24小时前提出取消原定预约课程，或者错过了一次原定预约课程的训练那么，训练馆将要将视为该节课程为消耗。</p>
							<p>3、课程时间一旦确定，教练会按时等候会员。如果会员迟到，迟到的时间将不获补偿，训练时间不会延长，将于原定时间结束。</p>
						</section>
						<section>
							<h3>七、SP瑜伽主题馆会员卡使用期限告知</h3>
							<p>训练馆所有会员卡均设有使用时间限制。如果购卡人在开卡之日算起后超过约定用卡有效期的情况，该卡视为过期作废处理。</p>
						</section>
					</section>
				</article>
...
<!-- 				<article class="weui-article" id="article-CrossFit" style="display: none;">
				...
				<article class="weui-article" id="article-bbs" style="display: none;">
					<section>
						<h2 class="title">SP-Training协议</h2>
						<section>
							<h3>一、会员卡</h3>
							<p>1、速扑运动SP-training所有课程均采用会员制服务模式，只有购买相关课程课时的会员才能享受训练场馆的各项专业小团体课程及相关配套服务。</p>
							<p>2、取得会员资格应办理入会手续，并已知晓训练馆有关健身的规则与警示，承诺遵守训练馆的相关规定。</p>
						...
						<section>
							<h3>三、电子会员卡的管理</h3>
							<p>1、会员课程卡仅供会员本人使用（体验卡除外），一经售出，概不退换。</p>
