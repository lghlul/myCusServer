				...
				<div infinite-scroll-disabled="loading" infinite-scroll-distance="200" class="my-lesson">
					...
					<div class="mask sjMask" style="display: none;">
						...
						<ul class="clearfix">
							...
							<a href="<%=request.getContextPath()%>/outside/buyCard/courseGroupPage">
								<li class="active three">训练营</li>
							</a>
					...
					<!---->
					<c:choose>
						<c:when test="${empty coursegroupclass}">
							<div class="blank">
								<div>你还没有训练营哦</div>
								<div>
						...
						<c:otherwise>
		 					<c:forEach items="${coursegroupclass }" var="items">
