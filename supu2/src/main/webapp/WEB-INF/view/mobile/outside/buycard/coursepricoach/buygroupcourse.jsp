				...
				<!-- 		<div flex="dir:left box:justify cross:center" class="le-cell coupon boder-1px-bottom">
						...
						<div flex="dir:left box:justify cross:center" class="le-cell padding-right boder-1px-bottom">
							...
							<div flex="main:justify" class="cell-wrapper">
								...
								<div class="value">
									<div class="le-cashier-price"><small >￥</small><span id="amount"> ${course.courseamount}</span></div>
								</div>
							</div>
							<div class="cell-right">
								<!---->
...
<!-- 后台日期已经被修改，请重新从训练营列表进入     暂时没有用到 -->
<div  class="mask failmask1" style="display:none;"></div>
<div id="alertFail1" class="mint-msgbox-wrapper" style="position: absolute; z-index: 2013; display:none;">
    <div class="mint-msgbox" style="display:block;">
        <div class="mint-msgbox-header">
            <div class="mint-msgbox-title" id="errorMassage1"></div>
        </div>
        <div class="mint-msgbox-content">
            <div class="mint-msgbox-message"></div>
            <div class="mint-msgbox-input" style="display: none;">
        ...
        <div class="mint-msgbox-btns">
        	<button onclick="window.location='<%=request.getContextPath()%>/outside/buyCard/courseGroupPage'" class="mint-msgbox-btn mint-msgbox-cancel btn_div" style="">确定</button>
        </div>
    </div>
</div>
	...
	// alert(openId);
 	...
 	var endDate='${endDate}';
 	 ...
 	 $('#sure_pay').click(function(){
        ...
        $.post(baseUrl+"/topayServlet?startDate="+startDate+"&endDate="+endDate+"&order_id="+order_id+"&total_fee="+ pay_gz+"&openid="+openId+"&cid="+courseid+'&type=2', function(data){
            	  ...
            	  WeixinJSBridge.invoke('getBrandWCPayRequest',{
            	       "appId" : appId,"timeStamp" : timeStamp, "nonceStr" : nonceStr, "package" : packageValue,"signType" : "MD5", "paySign" : paySign
            	                ...
            	                if(res.err_msg == "get_brand_wcpay_request:ok"){
            	                    //alert("支付成功");
            	                	   window.location.href=baseUrl+"/outside/buyCard/buyGrouCourseSucce";
