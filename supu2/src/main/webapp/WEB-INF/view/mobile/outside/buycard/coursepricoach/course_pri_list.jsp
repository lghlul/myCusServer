...
<!--    <link href="css/app.bc1787ce0ba559569c9c8c9be952468e.css" rel="stylesheet">
   <link href="css/gm-sijiaoke.css" rel="stylesheet"> -->
    ...
    <%--<link rel="stylesheet" href="<%=request.getContextPath()%>/assets/jQuery-WeUI/weui.min.css">--%>
    <%--<link rel="stylesheet" href="<%=request.getContextPath()%>/assets/jQuery-WeUI/jquery-weui.min.css">--%>
   <style type="text/css">
...
<body>
    ...
    <div class="body-box">
        <div class="index main">
            ...
            <div class="top-nav">
                <ul class="clearfix">
                    <li style="display: inline-block;width:25%;text-align: center"><a href="<%=request.getContextPath()%>/outside/buyCard/listPage">会员卡</a></li>
                    <li style="display: inline-block;width:25%;text-align: center"><span class="active">私教课</span></li>
                    <li style="display: inline-block;width:25%;text-align: center"><a href="<%=request.getContextPath()%>/outside/buyCard/courseGroupPage">训练营</a></li>
                    <li style="display: inline-block;width:25%;text-align: center"><a href="<%=request.getContextPath()%>/outside/buyCard/studioListPage">工作室</a></li>
                </ul>
            </div>
            ...
            <div>
                <img style="width:25px;height:25px;" src="<%=request.getContextPath()%>/assets/images/course_01.png " alt="">
                <span class="title text-left swiper-title">热门课程</span>
            </div>

           <!--人气swiper-->
           <div class="swiper-container2 swiper-box swiper-container-horizontal">
               <div class="swiper-wrapper">
                   <div class="swiper-slide swiper-slide-active"  style="width: 200px;">
                       <a href="/outside/buyCard/coursePriListDetail?id=10"><img class="pic hot-img" src="/upload/1505496443654.png"></a>
                       <div class="at-title-box">
                           <div class="hot-title">排毒瑜伽</div>
                           <div class="stars">
                               <span class=""></span>
                               <span class=""></span>
                               <span class=""></span>
                   ...
                   <div class="swiper-slide swiper-slide-next"  style="width: 200px;">
                       <a href="/outside/buyCard/coursePriListDetail?id=11"><img class="pic hot-img" src="/upload/1505500390589.png"></a>
                       <div class="at-title-box">
                           <div class="hot-title">增肌</div>
                           <div class="stars">
                               <span class=""></span>
                               <span class=""></span>
                               <span class=""></span>
                   ...
                   <div class="swiper-slide"  style="width: 200px;">
                       <a href="/outside/buyCard/coursePriListDetail?id=14"><img class="pic hot-img" src="/upload/1507887159377.png"></a>
                       <div class="at-title-box">
                           <div class="hot-title">测试体验课，请勿购买</div>
                           <div class="stars">
                               <span class=""></span>
                               <span class=""></span>
                               <span class=""></span>
                   ...
                   <div class="swiper-slide"  style="width: 200px;">
                       <a href="/outside/buyCard/coursePriListDetail?id=15"><img class="pic hot-img" src="/upload/1507944758274.png"></a>
                       <div class="at-title-box">
                           <div class="hot-title">测试课程，请勿购买</div>
                           <div class="stars">
                               <span class=""></span>
                               <span class=""></span>
                               <span class=""></span>
                ...
                <%--<div class="swiper-wrapper">--%>
                    ...
                    <%--<div class="swiper-slide"><a href="#"><img src="<%=request.getContextPath()%>/assets/images/swiper01.png" alt=""></a></div>--%>
                    <%--<div class="swiper-slide"><a href="#"><img src="<%=request.getContextPath()%>/assets/images/swiper01.png" alt=""></a></div>--%>
                    <%--<div class="swiper-slide"><a href="#"><img src="<%=request.getContextPath()%>/assets/images/swiper01.png" alt=""></a></div>--%>
                    <%--<div class="swiper-slide"><a href="#"><img src="<%=request.getContextPath()%>/assets/images/swiper01.png" alt=""></a></div>--%>
                    <%--<div class="swiper-slide"><a href="#"><img src="<%=request.getContextPath()%>/assets/images/swiper01.png" alt=""></a></div>--%>
                    <%--<div class="swiper-slide"><a href="#"><img src="<%=request.getContextPath()%>/assets/images/swiper01.png" alt=""></a></div>--%>
	                    <%--<c:forEach items="${coursePriCoach}" var="item" varStatus="status">--%>

							<%--<div class="swiper-slide swiper-slide-active" >--%>
		                   <%--<a href="<%=request.getContextPath()%>/outside/buyCard/coursePriListDetail?id=${item.id}"><img class="pic hot-img" src="${item.courseimg}"></a>--%>
		                        <%--<div class="at-title-box">--%>
		                            <%--<div class="hot-title">${item.coursename}</div>--%>
		                            <%--<div class="stars">--%>
		                                <%--<span class=""></span>--%>
		                                <%--<span class=""></span>--%>
		                                <%--<span class=""></span>--%>
    ...
    <%--<script src="<%=request.getContextPath()%>/assets/jQuery-WeUI/jquery-weui.min.js"></script>--%>
