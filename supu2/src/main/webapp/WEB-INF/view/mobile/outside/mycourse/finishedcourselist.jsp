				...
				<div class="container" style="padding: 0;">
					...
					<div class="container courses-container">
						...
						<c:forEach items="${course}" var="item" varStatus="status">
							<div class="le-courses-box courses-box" data-id=${item.courseid } data-type=${item.type }>
...
<script src="<%=request.getContextPath()%>/assets/js/outside/mycourse/finishcourselist.js"></script>