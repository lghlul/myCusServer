			...
			<div class="body-box">
				<div class="class-info">
					<div class="info-top clearfix"><img alt="" class="header-pic" src="https://img.leoao.com/o_1b4dnjmu91ibmjs0nvt103h12eop.png">
						<div class="info-box">
							<div class="class-name">${coachname }·1v1工作室</div>
							<div class="classNo">
					...
					<div class="top-message">
						<div class="time">
							<c:forEach items="${timeList }" var="items">
								<fmt:formatDate value="${items.appointtime }" pattern="yyyy-MM-dd" /> ${items.starttime }~${items.endtime }</br>
							</c:forEach>
							<span class="fn-right" style="color: rgb(250, 74, 17);">课程前后1小时可扫码入场</span>
						</div>
...
<%-- 								<div class="store-name">${store.storename }</div>
					...
					<div class="new-bottom no-boder">
						<div class="bottom-box clearfix">
							...
							<!---->
							<a href="<%=request.getContextPath()%>/outside/aboutClass/studioPage"><div class="right">确定</div></a>
							<!---->
							<!---->
							<!---->
						</div>
