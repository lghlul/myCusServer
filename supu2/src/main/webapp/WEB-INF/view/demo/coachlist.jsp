    ...
    <div class="external">
        <div class="page-header">
            ...
            <div class="menu-panel">
			 ...
			 <form id="form" class="form-horizontal" method="post" action="<%=request.getContextPath()%>/demo/addSave">
				<div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <input type="text" name="coachDtos[0].coachname" class="form-control" placeholder="请输入教练名称"  >
                    </div>
                </div>
				<div class="form-group">
                    <label class="col-sm-1 control-label">
                    ...
                    <div class="col-sm-5">
                        <input type="text" name="coachDtos[0].nickname" class="form-control" placeholder="请输入教练昵称"  maxlength="100">
                    </div>
                </div>
                    ...
                    <div class="col-sm-5">
                        <input type="text" name="coachDtos[1].coachname" class="form-control" placeholder="请输入教练名称"  >
                    </div>
                </div>
				<div class="form-group">
                    <label class="col-sm-1 control-label">
                    ...
                    <div class="col-sm-5">
                        <input type="text" name="coachDtos[1].nickname" class="form-control" placeholder="请输入教练昵称"  maxlength="100">
                    </div>
                </div>
	                    					   ...
	                    					   <div class="aR-info">
	                    					      ...
	                    					      <div class="region-info">
	                    					      		<c:forEach items="${region.storeList}" var="store">
	                    					    	  	 <label><input name="stores" class="stores" type="checkbox" value="${store.id}"/>${store.storename }</label>
	                    					    	   </c:forEach>
	                    					      </div>
	                    					   </div>
                    					  </div>
        ...
        <div class="modal fade" id="success" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <!-- 	<a id="a_infoLink" class="btn btn-default" href="">查看咨询</a> -->
                       <!--  <a class="btn btn-primary" href="javascript:void(0)">复制链接</a> -->
                        <a class="btn btn-info" href="<%=request.getContextPath() %>/user/coach/listPage">返回会员列表</a>
