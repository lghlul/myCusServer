    ...
    <div class="external">
        <div class="page-header">
            <ul class="breadcrumb">
                <li>
                    <i class="iconfont">&#xe648;</i>
                    <a href="javascript:void(0)">编辑会员</a>
                </li>
            </ul>
        </div>
			...
			<form id="form" class="form-horizontal" action="<%=request.getContextPath()%>/user/member/editSave" method="post">
				...
				<div class="form-group">
                    ...
                    <div class="col-sm-5 contentShow" id="div_membertype">
                     	<input class="courseGroupType membertype" type="radio" name="membertype" <c:if test="${member.membertype==1}"> checked="checked" </c:if> value="1">顾客
                    	<input class="courseGroupType membertype" type="radio" name="membertype" <c:if test="${member.membertype==2}"> checked="checked" </c:if> value="2">工作人员
				...
				<div class="form-group">
                    ...
                    <div class="col-sm-5">
                        ...
                        <input type="text" name="membername"  value="${member.membername}" class="form-control" placeholder="请输入会员名称" required="required" maxlength="100">
                    </div>
                </div>
				...
				<div class="form-group">
                    ...
                    <span >*</span>
                     ...
                     <div class="col-sm-5">
                        <input type="tel" name="phonenumber" value="${member.phonenumber}"  class="form-control" placeholder="请输入电话号码" >
                    </div>
                 </div>
				<div class="form-group">
                    <label class="col-sm-1 control-label">
				...
				<div class="form-group">
                 ...
                 <c:forEach items="${mCardChecked}" var="item" varStatus="status">
		 				...
		 				<%-- <div class="form-group" <c:if test="${!item.checked}">style="display:none;"</c:if> id="div_${item.id}">
		                    <label class="col-sm-1 control-label"></label>
		                    <div class="col-sm-1">
		                        <button type="button" class="btn">${item.membername}</button>
		                    </div>
		                     <div class="col-sm-4">
		                    	 		<input id="buytime${item.id}" type="text" <c:if test="${!item.checked}">disabled="true"</c:if>  name="memberMiddleCardList[${status.index}].buytime"
                ...
                <div class="modal-content">
                    ...
                    <!-- 	<a id="a_infoLink" class="btn btn-default" href="">查看咨询</a> -->
                       <!--  <a class="btn btn-primary" href="javascript:void(0)">复制链接</a> -->
                        ...
                        <a class="btn btn-success" href="<%=request.getContextPath() %>/user/member/editPage?id=${member.id}">继续编辑</a>
...
<script src="<%=request.getContextPath()%>/assets/js/member/edit_member.js"></script>
