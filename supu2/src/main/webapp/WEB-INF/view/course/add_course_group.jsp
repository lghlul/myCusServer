...
<body>
    <div class="external">
        <div class="page-header">
            <ul class="breadcrumb">
                <li>
                    <i class="iconfont">&#xe648;</i>
                    <a href="javascript:void(0)">新增训练营</a>
                </li>
            </ul>
        </div>
            ...
            <div class="menu-panel">
			 ...
			 <form id="form" class="form-horizontal">
			 	...
			 	<div class="form-group">
                    ...
                    <div class="col-sm-5">
                    	<a class="btn" style="color: #666" >团课</a>
                        <a id="a_course_pri" class="btn" style="color: #4CA8EB">切换为私教课</a>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-1 control-label">
                    ...
                    <div class="col-sm-5 contentShow">
                    	<input class="courseGroupType" type="radio" name="courseExcGroup.type" checked="checked" value="1">训练营
                    	 <input class="courseGroupType" type="radio" name="courseExcGroup.type" value="2">基础团课
				...
				<div class="form-group div_everyPeople" style="display:none">
                    <label class="col-sm-1 control-label">
                    <span >*</span>
                	      每堂课人数
                    </label>
				...
				<div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <input type="number" id="maxcoursepeople" name="courseExcGroup.maxpeople" class="form-control" placeholder="请输入最大课程名额"  maxlength="100">
                    </div>
                </div>
				<div class="form-group">
                    <label class="col-sm-1 control-label">
 ...
 --%>
                ...
                <div class="form-group div_totalhours">
                    <label class="col-sm-1 control-label">
                    <span >*</span>
                      	 总课时
                    </label>
                ...
                <div class="modal-body">
                    <div class="province">
						<c:forEach items="${coach}" var="items">
							<input type="checkbox" class="coachs" name="courseExcGroup.coachs" value="${items.id }" data-name=${items.coachname }>${items.coachname}
						</c:forEach>
                    </div>
                </div>
                <div class="modal-footer">
...
<script src="<%=request.getContextPath()%>/assets/js/uploadImg/js/imgPlugin.js"></script>
 <script src="<%=request.getContextPath()%>/assets/js/course/add_course_group.js"></script>
<script>
//JavaScript Document
$(function(){
	$(".single").first().show();
