    ...
    <div class="external">
        <div class="page-header">
            <ul class="breadcrumb">
                <li>
                    <i class="iconfont">&#xe648;</i>
                    <a href="javascript:void(0)">编辑私教课</a>
                </li>
            </ul>
        </div>
			...
			<input type="hidden" value="${coursePriCoach.id }" name="coursePriCoach.id">
			 <input type="hidden" name="type" value="0">
				...
				<div class="form-group">
                    ...
                    <div class="col-sm-5 contentShow">
                    	<c:forEach items="${courseFitDemand}" var="item" varStatus="status">
  									  ...
  									  <label><input name="coursePriCoach.fitdemand" type="radio"
 				...
 				<div class="form-group">
                    ...
                    <div class="col-sm-5">
                    	<input type="radio" id="isexperience" name="coursePriCoach.isexperience" value="0" <c:if test="${coursePriCoach.isexperience ==0}">checked="checked" </c:if>/>非体验课
                    	<input type="radio" id="isexperience" name="coursePriCoach.isexperience" value="1" <c:if test="${coursePriCoach.isexperience ==1}">checked="checked" </c:if>/>体验课
                    </div>
                </div>
				<div class="form-group">
                    <label class="col-sm-1 control-label">
				...
				<div class="form-group">
                    ...
                    <div class="col-sm-5">
                    	<input type="number" name="coursePriCoach.courseamount" class="form-control" value="${coursePriCoach.courseamount }" placeholder="输入课程金额">
                    </div>
                    <div class="col-sm-2 contentShow">
                    	元 / 课时
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <input type="number" name="coursePriCoach.totalhours" class="form-control" value="${coursePriCoach.totalhours }" placeholder="输入课时">
                    </div>
                    <div class="col-sm-2 contentShow">
                    	课时
                    </div>
                 ...
                 <div class="form-group">
                     ...
                     <div class="col-sm-5">
                         <input type="text" name="coursePriCoach.courseEndTimeStr" class="form-control" value="${coursePriCoach.courseEndTime}"
                                placeholder="选择月份" onclick="WdatePicker({dateFmt:'yyyy-MM-dd 00:00:00'});" />
                     </div>
                     <div class="col-sm-2 contentShow">
                     </div>
                 </div>
               ...
               <div class="form-group">
                    ...
                    <div class="col-sm-8">
                    <div class="tr-main">
                        <textarea name="coursePriCoach.coursedetail"  id="pcservicedetail"  style="width:700px;height:300px;">${coursePriCoach.coursedetail }</textarea>
                    </div>
                </div>
               </div>
                    					  ...
                    					  <div class="area-right">
	                    					   ...
	                    					   <div class="aR-info">
	                    					      ...
	                    					      <div class="region-info">
	                    					      		<c:forEach items="${region.storeList}" var="store">
	                    					    	  	 <label><input name="coursePriCoach.stores" class="stores" type="checkbox" value="${store.id}" <c:if test="${store.checked}">checked="checked"</c:if> data-name="${store.storename }"/>${store.storename }</label>
	                    					    	   </c:forEach>
	                    					      </div>
	                    					   </div>
                    					  </div>
                ...
                <div class="modal-body" style="overflow-y:auto; overflow-x:auto; width:90%; height:400px;margin-left: 5%;">
                    <div class="province">
                        <table>
                            <c:forEach items="${coach}" var="items">
                                <tr>
                                    <td><input type="checkbox" name="coursePriCoach.coachs"  class="coachs" <c:if test="${items.checked}">checked="checked"</c:if>  value="${items.id }" data-name=${items.coachname }>${items.coachname}</td>
                                    <td><input type="text" name="coursePriCoach.price" value="${items.price}" class="form-control" placeholder="价格/课时"/></td>
                                    <td><input type="text" name="coursePriCoach.orderNum" value="${items.orderNum}" class="form-control" placeholder="排序"/></td>
                                </tr>
                            </c:forEach>
                        </table>
                    </div>
                ...
                <div class="modal-content">
                    ...
                    <!-- 	<a id="a_infoLink" class="btn btn-default" href="">查看咨询</a> -->
                       <!--  <a class="btn btn-primary" href="javascript:void(0)">复制链接</a> -->
                        ...
                        <a class="btn btn-success" href="<%=request.getContextPath() %>/user/course/editPage?type=0&id=${coursePriCoach.id }">继续编辑</a>
