...
<div class="external">
	...
	<form id="form" method="get" action="<%=request.getContextPath()%>/user/course/addStudioChooseTime">
	    <div class="menu-panel">
	        ...
	        <div class="dfg">
	            ...
	            <a class="btn_quit" href="<%=request.getContextPath()%>/user/course/workspaceTimePage?courseId=${courseId}">取消</a>
	        </div>
	    </div>
	</form>
	   <!-- 模态框（Modal）失败后的框！ -->
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title release-failure">
                           <i class="iconfont">&#xe643;</i>
                          	<span id="span_msg">您本月对该工作室已经进行过排期</span>
                        </h4>
                    </div>
...
<script src="<%=request.getContextPath()%>/assets/js/course/schedule/studio/add_studio_choose_time.js"></script>
