    ...
    <div class="menu-panel">
        ...
        <div class="pull">
            ...
            <input type="hidden" value="${courseId }" id="courseId">
                <a href="<%=request.getContextPath()%>/user/course/addGroupTimePage?courseId=${courseId}"><input class="btn btn-sm btn-success" type="button"value="新增"></a>
            </div>
                ...
                <div class="fixed-table-container" style="padding-bottom: 0px;">
                    ...
                    <div class="fixed-table-body">
                        ...
                        <table class="table table-hover table-striped" id="tb">
                            <tbody>
                            <c:forEach items="${excTimeList }" var="items">
                                <tr data-index="2" data-uniqueid="1">
	                                <td style="text-align: center; vertical-align: middle; ">
	                                    <div class="col-sm-5 txt-left col-sm-offset-1"><fmt:formatDate value="${items.startdate}" pattern="yyyy年MM月dd日" />&nbsp;&nbsp;~&nbsp;&nbsp;<fmt:formatDate value="${items.enddate}" pattern="yyyy年MM月dd日" /></div>
	                                    <div class="col-sm-5 txt-right">
 										<c:if test="${!items.isEdit }">
	                                   	 	<a href="<%=request.getContextPath()%>/user/course/editExcTime?courseId=${courseId}&&startdate=<fmt:formatDate value="${items.startdate}" pattern="yyyy-MM-dd" />">
										</c:if>

											<button class="btn btn-bj editTime"
												 <c:if test="${items.isEdit }">disabled="disabled"
												</c:if>
											>编辑</button>
	                                        ...
	                                        <a href="<%=request.getContextPath()%>/user/course/detialExcTime?courseId=${courseId}&startdate=<fmt:formatDate value="${items.startdate}" pattern="yyyy-MM-dd" />"> -
