...
<div class="external">
    <div class="page-header">
        <ul class="breadcrumb">
            <li>
                <i class="iconfont">&#xe648;</i>
                <a href="javascript:void(0)">工作室排期</a>
            </li>
        </ul>
    ...
    <div class="menu-panel">
        ...
        <div class="pull">
            ...
            <input type="hidden" value="${courseId }" id="courseId">
                <a href="<%=request.getContextPath()%>/user/course/addStudioTime?courseId=${courseId}"><input class="btn btn-sm btn-success" type="button"value="新增"></a>
            </div>
                ...
                <div class="fixed-table-container" style="padding-bottom: 0px;">
                    ...
                    <div class="fixed-table-body">
                        ...
                        <table class="table table-hover table-striped" id="tb">
                            <tbody>
                            <c:forEach items="${studioTimeList }" var="items">
	                                ...
	                                <td style="text-align: center; vertical-align: middle; ">
	                                    ...
	                                    <div class="col-sm-5 txt-right">
  										<c:if test="${!items.isEdit }">
	                                   	 	<a href="<%=request.getContextPath()%>/user/course/addStudioChooseTime?courseId=${courseId}&&date=${items.year}-${items.month}&&type=1">
										</c:if>
											...
											<c:if test="${!items.isEdit }">
 	                                        ...
 	                                        <a href="<%=request.getContextPath()%>/user/course/detailStudioTime?courseId=${courseId}&&date=${items.year}-${items.month}">
