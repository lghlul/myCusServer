...
<form id="form" method="post" action="<%=request.getContextPath()%>" >
    <div class="menu-panel">
        ...
        <div class="framework">
            ...
            开始日期：
            <input id="" name="startDate" class="form-control kaiShi"
			  value="${date}"
            onFocus="WdatePicker({lang:'zh-cn',dateFmt:'yyyy-MM-dd',minDate: '%y-%M-#{%d+1}'})" type="text" placeholder="请选择日期">
  <!-- minDate: new Date()
  value="<fmt:formatDate value="<%=new Date()%>" pattern="yyyy-MM-dd" type="date"/>"
  -->
            <div class="row">
            ...
            <div class="row">
                <div class="col-sm-2 col-sm-offset-2">周二：</div>
 					<div class="col-sm-2">
		                 <input id="starttime1" name="courseExcTimeList[1].starttime" class="form-control startDate"
             		 ...
             		 <div class="col-sm-2">
                			<input id="endtime1"  name="courseExcTimeList[1].endtime" class="form-control endDate" onFocus="WdatePicker({lang:'zh-cn',dateFmt:'HH:mm',minDate:'#F{$dp.$D(\'starttime1\')}'})"
                			 type="text" placeholder="请选择时间">
                 	</div>
            </div>
                 <div class="row">
                <div class="col-sm-2 col-sm-offset-2">周三：</div>
                    <div class="col-sm-2">
		                 <input id="starttime2" name="courseExcTimeList[2].starttime" class="form-control startDate"
             		 ...
             		 <div class="col-sm-2">
                			<input id="endtime2"  name="courseExcTimeList[2].endtime" class="form-control endDate" onFocus="WdatePicker({lang:'zh-cn',dateFmt:'HH:mm',minDate:'#F{$dp.$D(\'starttime2\')}'})"
                			 type="text" placeholder="请选择时间">
                 </div>
            </div>
                 <div class="row">
                <div class="col-sm-2 col-sm-offset-2">周四：</div>
                     <div class="col-sm-2">
		                 <input id="starttime3" name="courseExcTimeList[3].starttime" class="form-control startDate"
             		 ...
             		 <div class="col-sm-2">
                			<input id="endtime3"  name="courseExcTimeList[3].endtime" class="form-control endDate" onFocus="WdatePicker({lang:'zh-cn',dateFmt:'HH:mm',minDate:'#F{$dp.$D(\'starttime3\')}'})"
                			 type="text" placeholder="请选择时间">
                 </div>
            </div>
                 <div class="row">
                <div class="col-sm-2 col-sm-offset-2">周五：</div>
                     <div class="col-sm-2">
		                 <input id="starttime4" name="courseExcTimeList[4].starttime" class="form-control startDate"
             		 ...
             		 <div class="col-sm-2">
                			<input id="endtime4"  name="courseExcTimeList[4].endtime" class="form-control endDate" onFocus="WdatePicker({lang:'zh-cn',dateFmt:'HH:mm',minDate:'#F{$dp.$D(\'starttime4\')}'})"
                			 type="text" placeholder="请选择时间">
                 </div>
            </div>
              <div class="row">
                <div class="col-sm-2 col-sm-offset-2">周六：</div>
                    <div class="col-sm-2">
		                 <input id="starttime5" name="courseExcTimeList[5].starttime" class="form-control startDate"
					...
					<input type="hidden" name="courseExcTimeList[5].week" value="7">
             		 ...
             		 <div class="col-sm-2">
                			<input id="endtime5"  name="courseExcTimeList[5].endtime" class="form-control endDate" onFocus="WdatePicker({lang:'zh-cn',dateFmt:'HH:mm',minDate:'#F{$dp.$D(\'starttime5\')}'})"
                			 type="text" placeholder="请选择时间">
                 </div>
            </div>
                 <div class="row">
                <div class="col-sm-2 col-sm-offset-2">周日：</div>
                   <div class="col-sm-2">
		                 <input id="starttime6" name="courseExcTimeList[6].starttime" class="form-control startDate"
					...
					<input type="hidden" name="courseExcTimeList[6].week" value="1">
             		 ...
             		 <div class="col-sm-2">
                			<input id="endtime6"  name="courseExcTimeList[6].endtime" class="form-control endDate" onFocus="WdatePicker({lang:'zh-cn',dateFmt:'HH:mm',minDate:'#F{$dp.$D(\'starttime6\')}'})"
                			 type="text" placeholder="请选择时间">
                 </div>
            </div>
        </div>
