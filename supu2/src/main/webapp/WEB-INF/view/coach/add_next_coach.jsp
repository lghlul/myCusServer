    ...
    <div class="external">
        <div class="page-header">
            <ul class="breadcrumb">
                <li>
                    <i class="iconfont">&#xe648;</i>
                    <a href="javascript:void(0)">添加教练</a>
                </li>
            </ul>
        </div>
				...
				<div id="div_append_certificate">
					<div class="form-group div_cetificate">
						<div class="col-sm-3 col-sm-offset-1">
							<input type="text" class="form-control"  placeholder="请输入证书名称" name="coachCertificate[0].name" >
						</div>
						<div class="col-sm-1">
							  		 <a href="javascript:;" class="file">上传证书
			    						<input type="file"  id="file0" onchange="previewImage(this)">
									</a>

							<input type="hidden" class="hidden"  id="certificatefile0" name="coachCertificate[0].certificateimg" >
						</div>
