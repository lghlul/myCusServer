		...
		<div class="external">
			<div class="page-header">
				<ul class="breadcrumb">
					<li>
						<i class="iconfont">&#xe648;</i>
						<a href="javascript:void(0)">私教时间列表</a>
					</li>
				</ul>
			</div>
			...
			<div class="menu-panel">
				...
				<div class="pull">
					<div class="pull-right">
                        <a href="<%=request.getContextPath() %>/user/pricoursetime/addPage">
					...
					<div class="divselect">
						<select id="select_StatusStore" name="status">
											...
											<c:forEach items="${coachList}" var="item"
												varStatus="status">
													<option  value="${item.id}">${item.coachname }</option>
											</c:forEach>
								...
								<input type="text" name="selectymonth" class="form-control" id="selectymonth"
				...
				<div class="tab-pane">
					<table class="table table-bordered" id="pritimelist">
					</table>
				</div>
...
<script>
 ...
 <script src="<%=request.getContextPath()%>/assets/js/pricoursetime/pri_time_list.js"></script>