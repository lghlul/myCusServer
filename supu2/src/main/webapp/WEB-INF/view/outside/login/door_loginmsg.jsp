            ...
            <div class="login-form">
                <form id="form" method="post" action="<%=request.getContextPath()%>/outside/door_login" accept-charset="utf-8">
                  ...
                  <!--       <div class="weui_cell">
                    ...
                    <button id="login" class="weui_btn leui_btn_warn form-submit" :class="{'leui_btn_disabled': disabled}">验证码登录</button>
                </form>
                ...
                <div class="le-other-items boder-1px-bottom">
                    <a href="javascript:;">
                        <div class="le-other-item">
                         <a href="<%=request.getContextPath()%>/outside/door_login">
                            <div class="le-item-iconfont">
                                <i class="iconfont icon-icon_login_sjyz"></i>
                            </div>
                            </a>
                            <a class="login" href="<%=request.getContextPath()%>/outside/door_login">密码登录</a>
                        </div>
                    </a>
                </div>
