								...
								<div class="my-lesson-list clearfix">
									...
									<div class="center">
										<div class="center-box">
											<div class="lesson-title">
												${items.coachname }
												<a href="tel://15755537670"></a>
											</div>
											<div class="lesson-name">私教课</div>
									...
									<div class="right">
										<form id="form1" action="<%=request.getContextPath()%>/outside/aboutClass/appointPage" method="POST">
											...
											<input type="hidden" value="" name="lng" id="lng"></input>
											<input type="hidden" value="" name="lat" id="lat"></input>
											<input type="hidden" value="${items.coachname}" name="coachname"></input>
											<input type="hidden" value="${items.courseid}" name="courseid"></input>
											<a id="clickspan"><span class="one fn-right">在线预约</span></a>
										</form>
