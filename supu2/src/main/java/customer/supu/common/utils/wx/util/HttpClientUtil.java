...
public class HttpClientUtil {
	 ...
	 */
	public String postData(String url) throws ServiceException {
	 ...
	 */
	public String postData(String url, List<NameValuePair> nameValuePairs,
			Map<String, String> headers) throws ServiceException {
		...
		try {
			...
			throw new ServiceException(
					ServiceExceptionConstants.UNKNOWN_SERVICE_ERROR, url
							+ "getMultipartData exception：", e);
	 ...
	 * @param url
	 *            服务器地址
	 * @return 返回响应的文本，如果请求发生异常，抛出ServiceException
	 * @throws ServiceException
	 */
	public String getData(String url) throws ServiceException {
	 ...
	 * @param headers
	 *            添加的请求header信息
	 * @return 返回服务器响应的文本，出错抛出ServiceException异常
	 * @throws ServiceException
	 */
	 ...
	 * @throws ServiceException
	 */
	public String deleteData(String url) throws ServiceException {
	 ...
	 * @throws ServiceException
	 */
	public byte[] getMultipartData(String url) throws ServiceException {
		long start = System.currentTimeMillis();
		HttpGet httpGet = new HttpGet(url);
		try {
			HttpResponse response = httpclient.execute(httpGet);
