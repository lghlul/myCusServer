...
Page({
    ...
    onLoad: function (options) {
        ...
        that.setData({
            ...
            type: options.type ? options.type : 'mistakes',
        ...
        let title = (that.data.type == 'mistakes') ? '活动回顾' : '练习模式'
        ...
        wx.request({
            ...
            success: function (result) {
                ...
                if (result.data.resultCode == 0) {
                    result.data.resultData.activityQuestions.forEach(function (question, index) {
                        question.answerList.forEach(function (item, index) {
                            ...
                            if (question.answerID) {
                                ...
                                wrongIndex = question.answerID.split(',').findIndex(ele => ele == item.ansID);
                                if (wrongIndex > -1) {
                                    item.choose = 'choose';
                                }
                            }
                    ...
                    questionData.allNum = result.data.resultData.activityQuestions.length;
                    questionData.questions = result.data.resultData.activityQuestions;
