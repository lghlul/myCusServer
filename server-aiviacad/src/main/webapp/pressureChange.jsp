...
<div class="top">
    ...
    <div class="login">
        <c:if test="${user == null}"> <a href="${basePath}/user/toLogin.do?flag=true">注册</a></c:if>
        <c:if test="${user == null}"> <a href="${basePath}/user/toLogin.do">登录</a></c:if>
        <c:if test="${user != null}"> 你好,<a href="${basePath}/user/toResetPwd.do"><span class="accountStyle">${user.userAccount}</span></a>
            <a href="${basePath}/user/logout.do">退出</a></c:if>
    </div>
</div>
...
<div style="width: 800px;margin: 100px auto;">
    <table style="margin:auto auto;" cellpadding="5px">
        <tr>
            ...
            <td>
                <input type="text">
                <div class="seaBtn" type="1">查询</div>
            </td>
            <td>
                兆帕<br/><span>(mPa)</span>
            </td>
            <td>
                <input type="text">
                <div class="seaBtn" type="2">查询</div>
            </td>
        </tr>
        <tr>
            <td>
            ...
            <td>
                <input type="text">
                <div class="seaBtn" type="3">查询</div>
            </td>
            <td>
                百帕<br/><span>(hPa)</span>
            </td>
            <td>
                <input type="text">
                <div class="seaBtn" type="4">查询</div>
            </td>
        </tr>
        <tr>
            <td>
            ...
            <td>
                <input type="text">
                <div class="seaBtn" type="5">查询</div>
            </td>
            <td>
                帕斯卡<br/><span>(Pa)</span>
            </td>
            <td>
                <input type="text">
                <div class="seaBtn" type="6">查询</div>
            </td>
        </tr>
        <tr>
            <td>
            ...
            <td>
                <input type="text">
                <div class="seaBtn" type="7">查询</div>
            </td>
            <td>
            ...
            <td>
                <input type="text">
                <div class="seaBtn" type="8">查询</div>
            </td>
        </tr>
        <tr>
            <td>
            ...
            <td>
                <input type="text">
                <div class="seaBtn" type="9">查询</div>
            </td>
            <td>
            ...
            <td>
                <input type="text">
                <div class="seaBtn" type="10">查询</div>
            </td>
        </tr>
        <tr>
            <td>
            ...
            <td>
                <input type="text">
                <div class="seaBtn" type="11">查询</div>
            </td>
            <td>
            ...
            <td>
                <input type="text">
                <div class="seaBtn" type="12">查询</div>
            </td>
        </tr>
        <tr>
            <td>
            ...
            <td>
                <input type="text">
                <div class="seaBtn" type="13">查询</div>
            </td>
            <td>
            ...
            <td>
                <input type="text">
                <div class="seaBtn" type="14">查询</div>
            </td>
        </tr>
    </table>
</div>
...
<div class="bottom">
    <div class="email">
        <img src="../images/email.png"/><span id="email" style="font-family: Microsoft YaHei;">&nbsp;站长邮箱:<a
            href="mailto:matlacdom@163.com">matlacdom@163.com</a></span>
    </div>
    <div class="count">
