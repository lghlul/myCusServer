...
<body>
	...
	<div class="gccx" style="margin-top: 100px;">
		...
		<form class="form-inline" id="findPwdForm" style="display: none;">
			...
			<div class="form-group  has-feedback">
				<span>*</span><input type="text" class="form-control input-lg" maxlength="6"  value="" name="emailCode" placeholder="请输入验证码" style="width: 55%;" oninput="value=value.replace(/[^\d]/g,'')"><button type="" class="btn input-lg" style="width: 35%;float: right;background-color: #5bc0de;color: white;" id="sendCodeBtn">获取验证码</button>
			</div>
			<div class="form-group  has-feedback">
				<span>*</span><input type="password" class="form-control input-lg" name="userPwd" value="" placeholder="请输入新密码">
			</div>
			<div class="form-group  has-feedback">
				<span>*</span><input type="password" class="form-control input-lg" name="userConfirmPwd" value="" placeholder="请输入确认密码">
			</div>
