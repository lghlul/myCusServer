    ...
    <div class="item">
        ...
        <div class="search">
            <div style="width:100%;height:120px;line-height:100px;text-align:center;">
                <input id="size_value" type="text" maxlength="5" style="width:100px;text-align:center;"/> <font
                    style="font-family: Arial Narrow;">mm</font>
            </div>
        </div>
    </div>
    <div class="item">
...
<div class="bottom">
    <div class="email">
        <img src="images/email.png"/><span id="email">&nbsp;站长邮箱:<a
