    ...
    <form class="form-horizontal" id="infoForm">
        <div class="form-group">
            ...
            <label class="col-sm-1 control-label"
                   style="padding-left: 0px ;padding-right: 0px;text-align: center">:</label>
            <label class="col-sm-5 control-label"
                   style="text-align: left;padding-left: 0px;">${user.userAccount}</label>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <label class="col-sm-1 control-label"
                   style="padding-left: 0px ;padding-right: 0px;text-align: center">:</label>
            <label class="col-sm-5 control-label" style="text-align: left;padding-left: 0px;"><a
                    href="javascript:void(0)" style="font-size: 15px;color: blue!important;"
                    id="toReset">修改密码</a></label>
        </div>
    </form>
