...
public interface TableMapper {
     ...
     * @return java.util.List<java.lang.String>
     */
    @Select("select COLUMN_NAME as columnName , DATA_TYPE as dataType  from INFORMATION_SCHEMA.COLUMNS where table_name = #{tableName} and table_schema = #{databaseName}")
