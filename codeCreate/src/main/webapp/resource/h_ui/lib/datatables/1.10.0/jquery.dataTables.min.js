(function(za, N, l) {
	var M = function(g) {
			function S(a) {
				var b, c, d = {};
				g.each(a, function(e) {
					if ((b = e.match(/^([^A-Z]+?)([A-Z])/)) && -1 !== "resource aa ai ao as b fn i m o s ".indexOf(b[1] + " ")) c = e.replace(b[0], b[2].toLowerCase()), d[c] = e, "o" === b[1] && S(a[e])
				});
				a._hungarianMap = d
			}
			function G(a, b, c) {
			...
			p.Api = q = function(a, b) {
				if (!this instanceof q) throw "DT API must be constructed as resource new object";
				var c = [],
					d = function(a) {
			...
			p.defaults = {
				...
				oLanguage: {
					...
					oPaginate: {
						sFirst: "第一页",
						sLast: "最后一页",
						sNext: '<i class="icon Hui-iconfont">&#xe6d7;</i>',
						sPrevious: '<i class="icon Hui-iconfont">&#xe6d4;</i>'
					},
					sEmptyTable: "没有数据",
					sInfo: "共计 _TOTAL_ 条信息",
					sInfoEmpty: "没有数据",
